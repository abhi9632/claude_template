...
3. Safe image fallbacks — remote images via SafeImage; descriptive alt; lazy below fold.
...
10. Auth cookies — HttpOnly + Secure + SameSite; never localStorage. (Verify if delegated.)
...
14. Production audit gate — full audit (below) + adversarial recheck before launch.
